...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_GPREL_ZCE_SWGP, 61)
  RELOC_NUMBER (R_RISCV_GPREL_ZCE_SDGP, 62)
  RELOC_NUMBER (R_RISCV_GPREL_ZCE_LWGP, 63)
  RELOC_NUMBER (R_RISCV_GPREL_ZCE_LDGP, 64)
